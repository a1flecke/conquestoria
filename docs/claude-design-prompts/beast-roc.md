...
1. https://raw.githubusercontent.com/a1flecke/conquestoria/main/src/renderer/sprites/v2/beast_wolf.svg.ts — canonical v2 format reference; internalize the wrapper structure and wound groups
...
3. https://raw.githubusercontent.com/a1flecke/conquestoria/main/src/assets/sprite-animations-v2.css — shared animation library; the `[data-kind="beast-winged"]` rules at the bottom control wing-flap and hover-bob automatically
