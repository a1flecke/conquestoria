...
- [ ] **Step 4: Review the final change**
  ...
  git diff origin/main...HEAD -- src/core/types.ts src/systems/combat-role-definitions.ts src/systems/city-system.ts tests/systems/combat-role-definitions.test.ts tests/systems/city-system.test.ts
  git status --short
  ```
...
- [ ] **Step 5: Commit the implementation**
  ...
  ```bash
  git add src/core/types.ts src/systems/combat-role-definitions.ts src/systems/city-system.ts tests/systems/combat-role-definitions.test.ts tests/systems/city-system.test.ts
