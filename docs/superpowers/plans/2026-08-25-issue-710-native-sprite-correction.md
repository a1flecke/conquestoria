...
- [x] **Step 1: Add native identity and semantic-hook failures.**
...
- [x] **Step 2: Strengthen catalog fallback parity failures.**
...
- [x] **Step 3: Add exact motion-selector failures.**
...
- [x] **Step 4: Add the file-safe evidence failure.**
...
- [x] **Step 5: Run the red contract and inspect the expected failures.**
...
- [x] **Step 1: Rebuild the five catalog fallbacks from the source prompt.**
...
- [x] **Step 2: Author matching native-v2 source components.**
...
- [x] **Step 3: Verify fallbacks and source shape before serialization.**
...
- [x] **Step 4: Commit the anatomy-only change.**
...
- [x] **Step 1: Add the five serializer pairs and native marker writer.**
...
- [x] **Step 2: Add actual catalog building preview data.**
...
- [x] **Step 3: Create the review page before generating data.**
...
- [x] **Step 4: Add variant-only CSS motion.**
...
- [x] **Step 5: Generate review-only data and verify green except native registration.**
...
- [x] **Step 6: Commit review-only artwork and motion.**
...
- [x] **Step 1: Capture exact review artifacts.**
...
- [x] **Step 2: Write the review record.**
...
- [x] **Step 3: Run evidence and focused proof.**
...
- [x] **Step 1: Add only the five approved generated imports and lookup entries.**
...
- [x] **Step 2: Run the complete focused proof.**
...
- [x] **Step 3: Run delivery verification separately.**
...
- [x] **Step 4: Commit registration and plan status.**
