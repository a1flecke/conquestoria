...
### Task 1: Lock the #711 visual and runtime contract with failing tests
...
- [ ] **Step 1: Add catalog identity regressions before replacing any alias.**
...
- [ ] **Step 2: Add native-route and faction regressions.**
...
- [ ] **Step 3: Add CSS selector regressions for actual locomotion and attacks.**
...
- [ ] **Step 4: Add renderer state and fog regressions.**
...
- [ ] **Step 5: Add a failing file-safe visual-review test.**
...
- [ ] **Step 6: Run the focused tests and confirm they fail for the intended missing behavior.**
...
### Task 2: Replace the catalog fallback aliases with four distinct static silhouettes
...
- [ ] **Step 1: Add the four named exports and preserve the exact static fallback contract.**
...
- [ ] **Step 2: Use shared material and faction constraints in each fallback.**
...
- [ ] **Step 3: Replace only the four alias registrations.**
...
- [ ] **Step 4: Run the fallback regression and source-rule check.**
...
- [ ] **Step 5: Commit the static fallback slice.**
...
### Task 3: Add the file-safe Issue #711 review surface and serializer payload plumbing
...
- [ ] **Step 1: Create the review page before adding the serializer writer.**
...
- [ ] **Step 2: Add serializer hooks for the #711 page.**
...
- [ ] **Step 3: Add the capture script and visual-review record.**
...
- [ ] **Step 4: Run the review-page test and confirm the new surface is file-safe.**
...
- [ ] **Step 5: Commit the review harness.**
...
### Task 4: Author, serialize, and route the native V2 sprites
...
- [ ] **Step 1: Add four `SpriteFrameV2` components with untransformed moving children.**
...
- [ ] **Step 2: Register the native source with the serializer and regenerate, never hand-editing generated payloads.**
...
- [ ] **Step 3: Route the generated components through the live V2 map lookup.**
...
- [ ] **Step 4: Run native serialization and routing tests.**
...
- [ ] **Step 5: Commit the editable source, generated assets, and lookup registration together.**
...
### Task 5: Add variant-owned locomotion and attacks
...
- [ ] **Step 1: Add the siege CSS with fixed chassis and local wheels/mechanisms.**
...
- [ ] **Step 2: Add the naval attack CSS without cancelling naval travel.**
...
- [ ] **Step 3: Preserve reduced motion without a duplicate override.**
...
### Task 6: Verify live state propagation, fog safety, and visual evidence
...
- [ ] **Step 1: Run the state and fog regressions after native routing is present.**
...
- [ ] **Step 2: Regenerate payload and capture the real review sheets.**
...
- [ ] **Step 3: Complete the visual review record with evidence-backed findings.**
...
- [ ] **Step 4: Run the complete targeted proof.**
...
- [ ] **Step 5: Inspect all branch and local deltas, then commit the evidence and plan progress.**
