...
**Status:** ✅ all 6 tasks implemented — PR #925 (branch `claude/issue-919-mr3-guidance`, 2026-08-30). Self-review fix: `CONQUEST_RESOLVER` now returns `await-conquest-settle` (now) as the primary lever instead of `research-constitutional-law` (an Era 5-7 tech). Full `yarn build` + `yarn test` green (549 files, 9347 tests).
