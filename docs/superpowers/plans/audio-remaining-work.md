...
- ~~Voice packs~~ — removed 2026-07-25: playtest feedback, advisor speech lines cut entirely; loss events now use the war-declared stinger placeholder (see 2026-07-25-remove-civ-voice-packs.md)
