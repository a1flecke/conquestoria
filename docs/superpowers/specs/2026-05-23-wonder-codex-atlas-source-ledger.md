...
| `video-coral-reef-art-park` | `coral_reef` | https://commons.wikimedia.org/wiki/File:Coral_Reef_Art.webm | VOA Africa | public domain VOA material | `/videos/wonders/coral-reef-art-park.mp4` | Stage 3B. Trimmed to 4 seconds from the cleaner underwater segment, scaled to 640px width, muted, and re-encoded as MP4/H.264 with OpenH264. Attribution: VOA Africa - public domain VOA material. |
