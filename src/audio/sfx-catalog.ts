...
export const UNIT_SFX: Partial<Record<UnitType, Partial<Record<SfxClass, TrackEntry>>>> = {
  ...
  air_freighter:    { death: real('sfx-air_freighter-death',    'audio/sfx/air_freighter-death.ogg',    0.500, 'death') },
  jet_freighter:    { death: real('sfx-jet_freighter-death',    'audio/sfx/jet_freighter-death.ogg',    0.550, 'death') },
  global_air_cargo: { death: real('sfx-global_air_cargo-death', 'audio/sfx/global_air_cargo-death.ogg', 0.600, 'death') },
  ...
  // === Era 13 units — generated by scripts/generate-era13-sfx.sh ===
  combat_drone: {
    'ranged-loose': real('sfx-combat-drone-fire', 'audio/sfx/combat-drone-fire.ogg', 0.52),
    'ranged-impact': real('sfx-combat-drone-impact', 'audio/sfx/combat-drone-impact.ogg', 0.46),
    death: real('sfx-combat-drone-death', 'audio/sfx/combat-drone-death.ogg', 0.72, 'death'),
  },
  autonomous_frigate: {
    'ranged-loose': real('sfx-autonomous-frigate-fire', 'audio/sfx/autonomous-frigate-fire.ogg', 0.62),
...
const LOCOMOTION_CLASS: Record<UnitType, LocomotionClass> = {
  ...
  // Trade Routes Overhaul (#553 MR3/4) — Air trade line, matches biplane's class
  air_freighter:    'air',
  jet_freighter:    'air',
