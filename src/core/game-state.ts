...
export function createNewGame(
  ...
  const state: GameState = {
    ...
    discoveredWonders: {},
    wonderDiscoverers: {},
    legendaryWonderHistory: { destroyedStrongholds: [], discoveredSites: [], militaryFacts: [] },
    legendaryWonderTacticalEffects: { trainingGrantsByCiv: {}, interceptionClaimTurnByCiv: {} },
