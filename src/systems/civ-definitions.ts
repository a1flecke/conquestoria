...
export const CIV_DEFINITIONS: CivDefinition[] = [
  {
    ...
    name: 'Egypt',
    color: '#c4a94d',
    cityNames: ['Thebes', 'Memphis', 'Heliopolis', 'Elephantine', 'Alexandria', 'Pi-Ramesses', 'Giza', 'Byblos', 'Amarna', 'Abydos', 'Hermopolis', 'Naukratis', 'Sais', 'Tanis', 'Bubastis', 'Coptos'],
  ...
  },
  {
    ...
    name: 'Rome',
    color: '#d94a4a',
    cityNames: ['Rome', 'Ostia', 'Antium', 'Cumae', 'Neapolis', 'Ravenna', 'Pompeii', 'Capua', 'Brundisium', 'Mediolanum', 'Placentia', 'Cremona', 'Lugdunum', 'Emerita', 'Hispalis', 'Aquileia'],
  ...
  },
  {
    ...
    name: 'Greece',
    color: '#4a90d9',
    cityNames: ['Athens', 'Sparta', 'Corinth', 'Argos', 'Delphi', 'Rhodes', 'Knossos', 'Mycenae', 'Thebes', 'Thessaloniki', 'Olympia', 'Eretria', 'Miletus', 'Chalcis', 'Syracuse', 'Heraklion'],
  ...
  },
  {
    ...
    name: 'Mongolia',
    color: '#4a9b4a',
    cityNames: ['Karakorum', 'Ulaanbaatar', 'Hohhot', 'Sukhbaatar', 'Tsetserleg', 'Mandalgovi', 'Dalanzadgad', 'Erdenet', 'Darkhan', 'Khovd', 'Moron', 'Choibalsan', 'Zuunmod', 'Bayankhongor', 'Uliastai', 'Sainshand'],
  ...
  },
  {
    ...
    name: 'Babylon',
    color: '#9b4ad9',
    cityNames: ['Babylon', 'Nineveh', 'Ur', 'Nippur', 'Eridu', 'Uruk', 'Lagash', 'Kish', 'Assur', 'Mari', 'Akkad', 'Sippar', 'Eshnunna', 'Umma', 'Kultepe', 'Adab'],
  ...
  },
  {
    ...
    name: 'Zulu',
    color: '#d9944a',
    cityNames: ['Ulundi', 'Nodwengu', 'Nobamba', 'Kwa-Bulawayo', 'Umgungundlovu', 'eMakhosini', 'Isandlwana', 'Mgungundlovu', 'Ondini', 'kwaDukuza', 'Nkandla', 'Babanango', 'Eziqwaqweni', 'Enkingeni', 'Emakhabeleni', 'Ophondweni'],
  ...
  },
  {
    ...
    name: 'China',
    color: '#d94a7b',
    cityNames: ['Beijing', 'Shanghai', 'Guangzhou', 'Nanjing', 'Xian', 'Chengdu', 'Hangzhou', 'Tianjin', 'Wuhan', 'Suzhou', 'Luoyang', 'Kunming', 'Quanzhou', 'Kaifeng', 'Zhengzhou', 'Yangzhou'],
  ...
  },
  {
    ...
    name: 'Persia',
    color: '#d9c44a',
    cityNames: ['Persepolis', 'Pasargadae', 'Susa', 'Ecbatana', 'Tarsus', 'Gordion', 'Bactra', 'Sardis', 'Ctesiphon', 'Artaxata', 'Zadrakarta', 'Rhagae', 'Hecatompylos', 'Dura-Europos', 'Hamadan', 'Soltaniyeh'],
    bonusName: 'Silk Road',
  ...
  },
  {
    ...
    name: 'England',
    color: '#4a6ad9',
    cityNames: ['London', 'York', 'Canterbury', 'Nottingham', 'Dover', 'Hastings', 'Oxford', 'Liverpool', 'Bristol', 'Birmingham', 'Winchester', 'Durham', 'Leicester', 'Coventry', 'Chester', 'Bath'],
  ...
  },
  {
    ...
    name: 'Aztec',
    color: '#4ad9a0',
    cityNames: ['Tenochtitlan', 'Teotihuacan', 'Tlatelolco', 'Texcoco', 'Tlaxcala', 'Calixtlahuaca', 'Xochicalco', 'Malinalco', 'Tula', 'Cholula', 'Cempoala', 'Ixtapalapa', 'Azcapotzalco', 'Cuicuilco', 'Tizatlan', 'Huexotzinco'],
  ...
  },
  {
    ...
    name: 'Japan',
    color: '#f0f0f0',
    cityNames: ['Kyoto', 'Osaka', 'Edo', 'Nagoya', 'Nara', 'Kamakura', 'Sapporo', 'Nagasaki', 'Hiroshima', 'Fukuoka', 'Kobe', 'Sendai', 'Niigata', 'Kanazawa', 'Hakodate', 'Yokohama'],
    bonusName: 'Bushido',
  ...
  },
  {
    ...
    name: 'India',
    color: '#d97a4a',
    cityNames: ['Delhi', 'Mumbai', 'Kolkata', 'Chennai', 'Bengaluru', 'Varanasi', 'Madurai', 'Ujjain', 'Agra', 'Hyderabad', 'Vijayanagara', 'Hampi', 'Kanchipuram', 'Nalanda', 'Mathura', 'Bodh Gaya'],
  ...
  // === M4a New Civilizations ===
  {
    ...
    name: 'France',
    color: '#1e3a8a',
    cityNames: ['Paris', 'Orleans', 'Lyon', 'Marseille', 'Bordeaux', 'Rouen', 'Reims', 'Avignon', 'Nantes', 'Strasbourg', 'Toulouse', 'Tours', 'Dijon', 'Caen', 'Amiens', 'Chartres'],
  ...
  },
  {
    ...
    name: 'Germany',
    color: '#78716c',
    cityNames: ['Berlin', 'Hamburg', 'Munich', 'Cologne', 'Frankfurt', 'Leipzig', 'Nuremberg', 'Dresden', 'Heidelberg', 'Mainz', 'Augsburg', 'Stuttgart', 'Bonn', 'Trier', 'Magdeburg', 'Lubeck'],
  ...
  },
  {
    ...
    name: 'Gondor',
    color: '#f5f5f4',
    cityNames: ['Minas Tirith', 'Osgiliath', 'Dol Amroth', 'Pelargir', 'Anfalas', 'Edhellond', 'Calembel', 'Linhir', 'Cair Andros', 'Amon Din', 'Pinnath Gelin', 'Tumladen', 'Lossarnach', 'Ethring', 'Belfalas', 'Morthond'],
  ...
  },
  {
    ...
    name: 'Rohan',
    color: '#65a30d',
    cityNames: ['Edoras', 'Aldburg', 'Helms Deep', 'Dunharrow', 'Snowbourn', 'Eastfold', 'Westfold', 'Grimslade', 'Upbourn', 'Harrowdale', 'Firienfeld', 'Underwall', 'Fenmarch', 'Entwade', 'Brokenborne', 'Eastemnet'],
  ...
  // === M4b1 New Civilizations ===
  {
    ...
    name: 'Russia',
    color: '#1e3a5f',
    cityNames: ['Moscow', 'St Petersburg', 'Novgorod', 'Kazan', 'Rostov', 'Yaroslavl', 'Vladivostok', 'Tver', 'Pskov', 'Ryazan', 'Suzdal', 'Vladimir', 'Murom', 'Smolensk', 'Saratov', 'Perm'],
  ...
  },
  {
    ...
    name: 'Ottoman Empire',
    color: '#b91c1c',
    cityNames: ['Istanbul', 'Edirne', 'Bursa', 'Konya', 'Izmir', 'Ankara', 'Trabzon', 'Gaziantep', 'Iznik', 'Bolu', 'Eskisehir', 'Sivas', 'Erzurum', 'Diyarbakir', 'Thessaloniki', 'Sarajevo'],
  ...
  },
  {
    ...
    name: 'The Shire',
    color: '#86efac',
    cityNames: ['Hobbiton', 'Bywater', 'Buckland', 'Tuckborough', 'Michel Delving', 'Frogmorton', 'Stock', 'Brandy Hall', 'Whitfurrows', 'Scary', 'Woodhall', 'Long Cleeve', 'Nobottle', 'Needlehole', 'Hardbottle', 'Overhill'],
  ...
  },
  {
    ...
    name: 'Isengard',
    color: '#374151',
    cityNames: ['Orthanc', 'Nan Curunir', 'Methedras', 'Dol Baran', 'Tharbad', 'Gap of Rohan', 'Fangorn Marches', 'Isen Ford', 'Helms Dike', 'Isen Vale', 'Wizard Vale', 'Angrenost', 'Dunland Heights', 'Wold Gate', 'Stonewain', 'Westemnet Gate'],
  ...
  // === M4c New Civilizations ===
  {
    ...
    name: 'Spain',
    color: '#c2410c',
    cityNames: ['Madrid', 'Barcelona', 'Seville', 'Toledo', 'Granada', 'Valencia', 'Cordoba', 'Salamanca', 'Zaragoza', 'Bilbao', 'Valladolid', 'Murcia', 'Burgos', 'Pamplona', 'Santiago', 'Segovia'],
  ...
  },
  {
    ...
    name: 'Viking',
    color: '#0f766e',
    cityNames: ['Nidaros', 'Hedeby', 'Uppsala', 'Ribe', 'Birka', 'Kaupang', 'Jorvik', 'Skiringssal', 'Staraja Ladoga', 'Sigtuna', 'Aarhus', 'Roskilde', 'Reykjavik', 'Lund', 'Dublin', 'Lindisfarne'],
  ...
  },
  {
    ...
    name: 'Prydain',
    color: '#7c3aed',
    cityNames: ['Caer Dathyl', 'Caer Colur', 'Caer Cadarn', 'Spiral Castle', 'Avren', 'Dinas Bran', 'Caer Moray', 'Caer Rhun', 'Free Commots', 'Hill Cantrevs', 'Caer Dalben', 'Cantrev Cadiffor', 'Mona', 'Caer Ceridwen'],
  ...
  },
  {
    ...
    name: 'Annuvin',
    color: '#111827',
    cityNames: ['Arawn Hold', 'Nightglass', 'Thornmere', 'Gloamreach', 'Umbral Court', 'Black Hollow', 'Shadowmere', 'Deathloch', 'Greyspire', 'Darkfen', 'Blackwater', 'Corpse Gate', 'Void Citadel', 'Dusk Keep'],
  ...
  },
  {
    ...
    color: '#6b3fa0',
    leaderName: 'TChalla',
    cityNames: ['Birnin Zana', 'Birnin Bashenga', 'Birnin Djata', 'Birnin Kashin', 'Birnin Tchamba', 'Birnin Salan', 'Alkama Fields', 'Jabari Lands', 'Birnin Azzaria', 'Birnin Mutata', 'Great Mound', 'Necropolis', 'High Hall', 'Warrior Falls', 'Panther Shrine', 'Golden City'],
  ...
  },
  {
    ...
    color: '#4a8fd9',
    leaderName: 'Arthur',
    cityNames: ['Camelot', 'Tintagel', 'Glastonbury', 'Avalon Isle', 'Caerleon', 'Lyonesse', 'Corbenic', 'Sarras', 'Joyous Gard', 'Astolat', 'Carbonek', 'Benoic', 'Logres', 'Dagonet', 'Caer Gai', 'Cameliard'],
  ...
  // === M4d New Civilizations ===
  {
    ...
    name: 'Lothlorien',
    color: '#4d7c0f',
    cityNames: ['Caras Galadhon', 'Lorien Ford', 'Galadhmere', 'Mallorn Rest', 'Cerin Amroth', 'Nimrodel', 'Celebrant Ford', 'Silverlode', 'Naith', 'Egladil', 'Lorinand', 'Lindorinand', 'Golden Wood', 'Tindómiel'],
  ...
  },
  {
    ...
    name: 'Narnia',
    color: '#60a5fa',
    cityNames: ['Cair Paravel', 'Lantern Waste', 'Beaversdam', 'Archenland Gate', 'Beruna', 'Dancing Lawn', 'Ettinsmoor', 'Stone Table', 'Redhaven', 'Galma', 'Terebinthia', 'Lone Islands', 'Anvard', 'Seven Isles'],
  ...
  },
  {
    ...
    name: 'Atlantis',
    color: '#0b7285',
    cityNames: ['Poseidonis', 'Aigera', 'Thalassar', 'Nereia', 'Blue Vault', 'Coral Crown', 'Abyssal Keep', 'Tidemark', 'Pelagius', 'Brine Gate', 'Crystal Spire', 'Neptunion', 'Seahaven', 'Deepwatch'],
