...
export const UNIT_ROLE_DEFINITIONS = {
  ...
  beast_handler: role('detection', 'Mobile detection support that reveals disguised spies while staying with the formation.', ['detection'], { secondaryRoles: ['formation-support'], counters: ['formation-support'], vulnerableTo: ['ranged'], upgradeFamily: 'detection', terminalReason: 'War Elephant Corps is future content.' }),
