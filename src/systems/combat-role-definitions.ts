...
export const UNIT_ROLE_DEFINITIONS = {
  ...
  trebuchet: role('siege', 'Slow siege engine that hits cities harder but is weak against units.', ['siege', 'ranged'], { counters: ['frontline'], vulnerableTo: ['shock', 'pursuit'], upgradeFamily: 'siege', publicFacts: ['+25% city assault strength', '−20% unit combat strength'] }),
