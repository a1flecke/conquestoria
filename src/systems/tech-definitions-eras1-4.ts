...
export const TECH_TREE_ERAS_1_4: Tech[] = [
  ...
  { id: 'horseback-riding', name: 'Horseback Riding', track: 'military', cost: 25, prerequisites: ['animal-husbandry'], unlocks: [], unlocksUnits: ['horseman'], unlocksBuildings: ['stable', 'cavalry-academy'], era: 2 },
