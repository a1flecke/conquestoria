...
export const TECH_TREE_ERAS_1_4: Tech[] = [
  ...
  { id: 'harbor-tech', name: 'Harbors', track: 'exploration', cost: 55, prerequisites: ['sailing', 'currency'], unlocks: [], unlocksBuildings: ['harbor'], era: 3 },
  { id: 'exploration-tech', name: 'Exploration', track: 'exploration', cost: 70, prerequisites: ['celestial-navigation'], unlocks: ['All units +1 vision range'], era: 4 },
  ...
  { id: 'crop-rotation', name: 'Crop Rotation', track: 'agriculture', cost: 30, prerequisites: ['domestication', 'irrigation'], unlocks: ['Improved farms'], era: 2 },
  ...
  { id: 'fertilization', name: 'Fertilization', track: 'agriculture', cost: 55, prerequisites: ['crop-rotation'], unlocks: ['Fertile fields'], era: 3 },
  { id: 'livestock-breeding', name: 'Livestock Breeding', track: 'agriculture', cost: 55, prerequisites: ['crop-rotation', 'granary-design'], unlocks: ['Improved cattle and livestock management'], era: 3 },
  { id: 'selective-breeding', name: 'Selective Breeding', track: 'agriculture', cost: 75, prerequisites: ['livestock-breeding'], unlocks: ['Hybrid crops'], era: 4 },
  { id: 'agricultural-science', name: 'Agricultural Science', track: 'agriculture', cost: 95, prerequisites: ['fertilization', 'livestock-breeding'], unlocks: ['Agricultural lab'], era: 4 },
  ...
  { id: 'sanitation', name: 'Sanitation', track: 'medicine', cost: 25, prerequisites: ['bone-setting'], unlocks: ['Public sanitation practices'], era: 2 },
  { id: 'midwifery', name: 'Midwifery', track: 'medicine', cost: 10, prerequisites: ['herbalism'], unlocks: ['Maternal care traditions'], era: 2 },
  { id: 'surgery', name: 'Surgery', track: 'medicine', cost: 55, prerequisites: ['sanitation', 'philosophy'], unlocks: ['Advanced surgical knowledge'], era: 3 },
  { id: 'quarantine', name: 'Quarantine', track: 'medicine', cost: 55, prerequisites: ['sanitation'], unlocks: ['Disease containment practices'], era: 3 },
  { id: 'apothecary', name: 'Apothecary', track: 'medicine', cost: 75, prerequisites: ['surgery'], unlocks: ['Herbal remedy traditions'], era: 4 },
  { id: 'anatomy', name: 'Anatomy', track: 'medicine', cost: 95, prerequisites: ['surgery', 'quarantine'], unlocks: ['Systematic anatomical study'], era: 4 },
  ...
  { id: 'ethics', name: 'Ethics', track: 'philosophy', cost: 30, prerequisites: ['mythology', 'writing'], unlocks: ['Ethical code'], era: 2 },
  ...
  { id: 'logic', name: 'Logic', track: 'philosophy', cost: 55, prerequisites: ['ethics', 'rhetoric'], unlocks: ['Formal logical reasoning'], era: 3 },
  { id: 'metaphysics', name: 'Metaphysics', track: 'philosophy', cost: 55, prerequisites: ['ethics'], unlocks: ['Metaphysical inquiry traditions'], era: 3 },
  { id: 'humanism', name: 'Humanism', track: 'philosophy', cost: 95, prerequisites: ['logic', 'metaphysics'], unlocks: ['Enlightenment'], era: 4 },
  { id: 'natural-philosophy', name: 'Natural Philosophy', track: 'philosophy', cost: 75, prerequisites: ['logic'], unlocks: ['Empiricism'], era: 4 },
  ...
  { id: 'pottery-arts', name: 'Pottery Arts', track: 'arts', cost: 30, prerequisites: ['storytelling', 'pottery'], unlocks: ['Ceramic craft traditions'], era: 2 },
  { id: 'music', name: 'Music', track: 'arts', cost: 25, prerequisites: ['storytelling'], unlocks: ['Musical traditions'], era: 2 },
  { id: 'sculpture', name: 'Sculpture', track: 'arts', cost: 45, prerequisites: ['pottery-arts'], unlocks: ['Monumental art traditions'], era: 3 },
  { id: 'drama', name: 'Drama', track: 'arts', cost: 55, prerequisites: ['music', 'pottery-arts'], unlocks: ['Formal dramatic performance traditions'], era: 3 },
  { id: 'theater', name: 'Theater', track: 'arts', cost: 75, prerequisites: ['drama'], unlocks: ['Theatrical performance traditions'], era: 4 },
  { id: 'architecture-arts', name: 'Architecture Arts', track: 'arts', cost: 65, prerequisites: ['sculpture', 'drama'], unlocks: ['Monumental architecture traditions'], era: 4 },
  ...
  { id: 'harbor-building', name: 'Harbor Building', track: 'maritime', cost: 55, prerequisites: ['galleys'], unlocks: ['Maritime infrastructure — prerequisite for Caravels'], era: 3 },
  { id: 'caravels', name: 'Caravels', track: 'maritime', cost: 95, prerequisites: ['triremes', 'harbor-building'], unlocks: [], unlocksUnits: ['steamship'], era: 4 },
  { id: 'naval-warfare', name: 'Naval Warfare', track: 'maritime', cost: 75, prerequisites: ['triremes'], unlocks: ['Unlocks advanced naval tactics'], era: 4 },
  ...
  { id: 'bronze-casting', name: 'Bronze Casting', track: 'metallurgy', cost: 30, prerequisites: ['smelting', 'bronze-working'], unlocks: ['Bronze armor'], era: 2 },
  { id: 'tool-making', name: 'Tool Making', track: 'metallurgy', cost: 25, prerequisites: ['smelting'], unlocks: ['Improved tools'], era: 2 },
  { id: 'iron-smelting', name: 'Iron Smelting', track: 'metallurgy', cost: 55, prerequisites: ['bronze-casting'], unlocks: ['Iron ore'], era: 3 },
  { id: 'alloys', name: 'Alloys', track: 'metallurgy', cost: 55, prerequisites: ['bronze-casting', 'tool-making'], unlocks: ['Alloy weapons'], era: 3 },
  { id: 'steel-forging', name: 'Steel Forging', track: 'metallurgy', cost: 95, prerequisites: ['iron-smelting', 'alloys'], unlocks: ['Steel weapons'], era: 4 },
  { id: 'armor-craft', name: 'Armor Craft', track: 'metallurgy', cost: 75, prerequisites: ['iron-smelting'], unlocks: ['Plate armor'], era: 4 },
  ...
  { id: 'masonry', name: 'Masonry', track: 'construction', cost: 25, prerequisites: ['thatching'], unlocks: ['Stone construction traditions'], era: 2 },
  ...
  { id: 'pictographs', name: 'Pictographs', track: 'communication', cost: 30, prerequisites: ['smoke-signals', 'writing'], unlocks: ['Record keeping'], era: 2 },
  { id: 'messengers', name: 'Messengers', track: 'communication', cost: 25, prerequisites: ['smoke-signals'], unlocks: ['Messenger relay traditions'], era: 2 },
  { id: 'courier-networks', name: 'Courier Networks', track: 'communication', cost: 55, prerequisites: ['messengers', 'pictographs'], unlocks: ['Long-distance courier traditions'], era: 3 },
  { id: 'ciphers', name: 'Ciphers', track: 'communication', cost: 55, prerequisites: ['pictographs'], unlocks: ['Encoded messages'], era: 3 },
  { id: 'printing', name: 'Printing', track: 'communication', cost: 75, prerequisites: ['courier-networks'], unlocks: ['Printed media traditions'], unlocksBuildings: ['imperial_archive'], era: 4 },
  { id: 'diplomats', name: 'Diplomats', track: 'communication', cost: 95, prerequisites: ['courier-networks', 'ciphers'], unlocks: ['Formal diplomatic traditions'], era: 4 },
  ...
  { id: 'espionage-scouting', name: 'Scouting Networks', track: 'espionage', cost: 16, prerequisites: [], unlocks: ['Recruit spies', 'Passive city surveillance', 'Scout Area mission', 'Monitor Troops mission'], unlocksUnits: ['spy_scout'], unlocksBuildings: ['safehouse'], era: 1,
  ...
  { id: 'shamanism', name: 'Shamanism', track: 'spirituality', cost: 30, prerequisites: ['burial-rites', 'tribal-council'], unlocks: ['Shamanic ritual traditions'], era: 2 },
  { id: 'sacred-sites', name: 'Sacred Sites', track: 'spirituality', cost: 25, prerequisites: ['burial-rites'], unlocks: ['Sacred-site veneration traditions'], era: 2 },
  { id: 'temples', name: 'Temples', track: 'spirituality', cost: 55, prerequisites: ['shamanism', 'sacred-sites'], unlocks: ['Organized worship traditions'], era: 3 },
  { id: 'priesthood', name: 'Priesthood', track: 'spirituality', cost: 55, prerequisites: ['shamanism'], unlocks: ['Priestly class traditions'], era: 3 },
