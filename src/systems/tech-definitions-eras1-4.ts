...
export const TECH_TREE_ERAS_1_4: Tech[] = [
  ...
  { id: 'horseback-riding', name: 'Horseback Riding', track: 'military', cost: 25, prerequisites: ['animal-husbandry'], unlocks: [], unlocksUnits: ['horseman', 'cavalry'], unlocksBuildings: ['stable', 'cavalry-academy'], era: 2 },
  ...
  { id: 'tactics', name: 'Tactics', track: 'military', cost: 70, prerequisites: ['iron-forging'], unlocks: ['Units get +10% combat bonus'], unlocksUnits: ['crossbowman'], unlocksBuildings: ['praetorian_legion'], era: 4 },
