...
const ERA_10_TECHS: Tech[] = [
  // MILITARY (2)
  { id: 'jet-aviation', name: 'Jet Aviation', track: 'military', cost: 925,
  ...
  { id: 'nuclear-weapons', name: 'Nuclear Weapons', track: 'military', cost: 925,
  ...
  // ECONOMY (2)
  { id: 'keynesian-economics', name: 'Keynesian Economics', track: 'economy', cost: 640,
  ...
  { id: 'consumer-boom', name: 'Consumer Boom', track: 'economy', cost: 640,
  ...
  // SCIENCE (2)
  { id: 'nuclear-physics', name: 'Nuclear Physics', track: 'science', cost: 925,
  ...
  { id: 'nuclear-theory', name: 'Nuclear Theory', track: 'science', cost: 925,
    prerequisites: ['quantum-theory'],
    unlocks: ['+2 science empire-wide'], era: 10, countsForEraAdvancement: false },
  { id: 'radar-systems', name: 'Radar Systems', track: 'science', cost: 640,
  ...
  // CIVICS (2)
  { id: 'decolonization', name: 'Decolonization', track: 'civics', cost: 640,
  ...
  { id: 'international-institutions', name: 'International Institutions', track: 'civics', cost: 640,
  ...
  // EXPLORATION (2)
  { id: 'rocketry', name: 'Rocketry', track: 'exploration', cost: 925,
  ...
  { id: 'polar-operations', name: 'Polar Operations', track: 'exploration', cost: 280,
  ...
  // AGRICULTURE (2)
  { id: 'pesticides', name: 'Pesticides', track: 'agriculture', cost: 640,
  ...
  { id: 'mechanized-agriculture', name: 'Mechanized Agriculture', track: 'agriculture', cost: 640,
  ...
  // MEDICINE (2)
  { id: 'penicillin', name: 'Penicillin', track: 'medicine', cost: 460,
  ...
  { id: 'universal-healthcare', name: 'Universal Healthcare', track: 'medicine', cost: 640,
  ...
  // PHILOSOPHY (2)
  { id: 'post-colonial-theory', name: 'Post-Colonial Theory', track: 'philosophy', cost: 640,
  ...
  { id: 'human-rights-framework', name: 'Human Rights Framework', track: 'philosophy', cost: 640,
  ...
  // ARTS (2)
  { id: 'abstract-expressionism', name: 'Abstract Expressionism', track: 'arts', cost: 640,
  ...
  { id: 'rock-and-roll', name: 'Rock and Roll', track: 'arts', cost: 640,
  ...
  // MARITIME (2)
  { id: 'carrier-warfare', name: 'Carrier Warfare', track: 'maritime', cost: 925,
  ...
  { id: 'amphibious-assault', name: 'Amphibious Assault', track: 'maritime', cost: 460,
  ...
  // METALLURGY (2)
  { id: 'titanium-processing', name: 'Titanium Processing', track: 'metallurgy', cost: 640,
  ...
  { id: 'synthetic-polymers', name: 'Synthetic Polymers', track: 'metallurgy', cost: 640,
  ...
  // CONSTRUCTION (2)
  { id: 'nuclear-power', name: 'Nuclear Power', track: 'construction', cost: 925,
  ...
  { id: 'highway-network', name: 'Highway Network', track: 'construction', cost: 640,
  ...
  // COMMUNICATION (2)
  { id: 'television', name: 'Television', track: 'communication', cost: 640,
  ...
  { id: 'electronic-computing', name: 'Electronic Computing', track: 'communication', cost: 640,
  ...
  // ESPIONAGE (2)
  { id: 'signals-intelligence', name: 'Signals Intelligence', track: 'espionage', cost: 640,
  ...
  { id: 'cold-war-networks', name: 'Cold War Networks', track: 'espionage', cost: 640,
  ...
  { id: 'digital-surveillance', name: 'Digital Surveillance', track: 'espionage', cost: 640,
    prerequisites: ['counterintelligence', 'signals-intelligence'],
    unlocks: ['Satellite Surveillance', 'Misinformation Campaign'], era: 10 },

  // SPIRITUALITY (2)
  { id: 'liberation-theology', name: 'Liberation Theology', track: 'spirituality', cost: 640,
  ...
  { id: 'interfaith-council', name: 'Interfaith Council', track: 'spirituality', cost: 280,
