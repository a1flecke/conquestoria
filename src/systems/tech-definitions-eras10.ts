...
const ERA_10_TECHS: Tech[] = [
  // MILITARY (2)
  { id: 'jet-aviation', name: 'Jet Aviation', track: 'military', cost: 290,
  ...
  { id: 'nuclear-weapons', name: 'Nuclear Weapons', track: 'military', cost: 295,
    ...
    unlocks: ['Atomic deterrence reshapes grand strategy; city siege operations gain a decisive edge'],
    unlocksBuildings: ['nuclear_arsenal', 'manhattan_project'], era: 10 },

  // ECONOMY (2)
  { id: 'keynesian-economics', name: 'Keynesian Economics', track: 'economy', cost: 285,
  ...
  { id: 'consumer-boom', name: 'Consumer Boom', track: 'economy', cost: 285,
  ...
  // SCIENCE (2)
  { id: 'nuclear-physics', name: 'Nuclear Physics', track: 'science', cost: 295,
  ...
  // CIVICS (2)
  { id: 'decolonization', name: 'Decolonization', track: 'civics', cost: 285,
  ...
  { id: 'international-institutions', name: 'International Institutions', track: 'civics', cost: 290,
  ...
  // EXPLORATION (2)
  { id: 'rocketry', name: 'Rocketry', track: 'exploration', cost: 295,
  ...
  // AGRICULTURE (2)
  { id: 'pesticides', name: 'Pesticides', track: 'agriculture', cost: 285,
  ...
  { id: 'mechanized-agriculture', name: 'Mechanized Agriculture', track: 'agriculture', cost: 285,
  ...
  // MEDICINE (2)
  { id: 'penicillin', name: 'Penicillin', track: 'medicine', cost: 285,
  ...
  { id: 'universal-healthcare', name: 'Universal Healthcare', track: 'medicine', cost: 285,
  ...
  // PHILOSOPHY (2)
  { id: 'post-colonial-theory', name: 'Post-Colonial Theory', track: 'philosophy', cost: 285,
  ...
  { id: 'human-rights-framework', name: 'Human Rights Framework', track: 'philosophy', cost: 285,
  ...
  // ARTS (2)
  { id: 'abstract-expressionism', name: 'Abstract Expressionism', track: 'arts', cost: 285,
  ...
  { id: 'carrier-warfare', name: 'Carrier Warfare', track: 'maritime', cost: 295,
    ...
    unlocksUnits: ['carrier'], era: 10 },
  { id: 'amphibious-assault', name: 'Amphibious Assault', track: 'maritime', cost: 290,
  ...
  // METALLURGY (2)
  { id: 'titanium-processing', name: 'Titanium Processing', track: 'metallurgy', cost: 290,
  ...
  { id: 'synthetic-polymers', name: 'Synthetic Polymers', track: 'metallurgy', cost: 285,
  ...
  // COMMUNICATION (2)
  { id: 'television', name: 'Television', track: 'communication', cost: 285,
  ...
  { id: 'electronic-computing', name: 'Electronic Computing', track: 'communication', cost: 290,
  ...
  // ESPIONAGE (2)
  { id: 'signals-intelligence', name: 'Signals Intelligence', track: 'espionage', cost: 285,
