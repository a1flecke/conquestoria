...
const ERA_10_TECHS: Tech[] = [
  // MILITARY (2)
  { id: 'jet-aviation', name: 'Jet Aviation', track: 'military', cost: 2080,
  ...
  { id: 'nuclear-weapons', name: 'Nuclear Weapons', track: 'military', cost: 2080,
  ...
  // AGRICULTURE (2)
  { id: 'pesticides', name: 'Pesticides', track: 'agriculture', cost: 1040,
  ...
  { id: 'mechanized-agriculture', name: 'Mechanized Agriculture', track: 'agriculture', cost: 1040,
  ...
  // MEDICINE (2)
  { id: 'penicillin', name: 'Penicillin', track: 'medicine', cost: 960,
  ...
  { id: 'rock-and-roll', name: 'Rock and Roll', track: 'arts', cost: 1040,
  ...
  // MARITIME (2)
  { id: 'carrier-warfare', name: 'Carrier Warfare', track: 'maritime', cost: 2080,
  ...
  { id: 'amphibious-assault', name: 'Amphibious Assault', track: 'maritime', cost: 960,
  ...
  // METALLURGY (2)
  { id: 'titanium-processing', name: 'Titanium Processing', track: 'metallurgy', cost: 1040,
  ...
  // CONSTRUCTION (2)
  { id: 'nuclear-power', name: 'Nuclear Power', track: 'construction', cost: 1040,
  ...
  // SPIRITUALITY (2)
  { id: 'liberation-theology', name: 'Liberation Theology', track: 'spirituality', cost: 1040,
