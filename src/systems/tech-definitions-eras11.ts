...
const ERA_11_TECHS: Tech[] = [
  // MILITARY (2)
  { id: 'helicopter-warfare', name: 'Helicopter Warfare', track: 'military', cost: 310,
  ...
  { id: 'icbm-development', name: 'ICBM Development', track: 'military', cost: 315,
  ...
  // ECONOMY (2)
  { id: 'stagflation-response', name: 'Stagflation Response', track: 'economy', cost: 305,
  ...
  { id: 'petrodollar-system', name: 'Petrodollar System', track: 'economy', cost: 300,
  ...
  // SCIENCE (2)
  { id: 'integrated-circuits', name: 'Integrated Circuits', track: 'science', cost: 310,
  ...
  { id: 'molecular-biology', name: 'Molecular Biology', track: 'science', cost: 310,
  ...
  // CIVICS (2)
  { id: 'arms-control-negotiations', name: 'Arms Control Negotiations', track: 'civics', cost: 305,
  ...
  { id: 'civil-rights-legislation', name: 'Civil Rights Legislation', track: 'civics', cost: 305,
  ...
  // EXPLORATION (2)
  { id: 'space-exploration', name: 'Space Exploration', track: 'exploration', cost: 315,
  ...
  { id: 'deep-sea-drilling', name: 'Deep-Sea Drilling', track: 'exploration', cost: 300,
  ...
  // AGRICULTURE (2)
  { id: 'green-revolution-crops', name: 'Green Revolution Crops', track: 'agriculture', cost: 305,
  ...
  { id: 'aquaculture', name: 'Aquaculture', track: 'agriculture', cost: 300,
  ...
  // MEDICINE (2)
  { id: 'organ-transplantation', name: 'Organ Transplantation', track: 'medicine', cost: 310,
  ...
  { id: 'vaccination-campaigns', name: 'Vaccination Campaigns', track: 'medicine', cost: 300,
  ...
  // PHILOSOPHY (2)
  { id: 'structuralism', name: 'Structuralism', track: 'philosophy', cost: 305,
  ...
  { id: 'container-shipping', name: 'Container Shipping', track: 'maritime', cost: 300,
  ...
  // METALLURGY (2)
  { id: 'carbon-fiber', name: 'Carbon Fibre', track: 'metallurgy', cost: 310,
  ...
  { id: 'precision-engineering', name: 'Precision Engineering', track: 'metallurgy', cost: 305,
  ...
  // CONSTRUCTION (2)
  { id: 'megastructures', name: 'Megastructures', track: 'construction', cost: 310,
  ...
  { id: 'offshore-platforms', name: 'Offshore Platforms', track: 'construction', cost: 305,
  ...
  // COMMUNICATION (2)
  { id: 'arpanet', name: 'ARPANET', track: 'communication', cost: 310,
  ...
  { id: 'satellite-television', name: 'Satellite Television', track: 'communication', cost: 305,
  ...
  // ESPIONAGE (2)
  { id: 'satellite-surveillance', name: 'Satellite Surveillance', track: 'espionage', cost: 310,
  ...
  { id: 'black-ops-programs', name: 'Black Ops Programs', track: 'espionage', cost: 305,
  ...
  // SPIRITUALITY (2)
  { id: 'ecumenical-movement', name: 'Ecumenical Movement', track: 'spirituality', cost: 300,
