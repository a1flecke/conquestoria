...
const ERA_11_TECHS: Tech[] = [
  // MILITARY (2)
  { id: 'helicopter-warfare', name: 'Helicopter Warfare', track: 'military', cost: 2725,
  ...
  { id: 'icbm-development', name: 'ICBM Development', track: 'military', cost: 1360,
  ...
  { id: 'counterculture', name: 'Counterculture', track: 'arts', cost: 1360,
  ...
  // MARITIME (2)
  { id: 'nuclear-submarines', name: 'Nuclear Submarines', track: 'maritime', cost: 2725,
  ...
  { id: 'container-shipping', name: 'Container Shipping', track: 'maritime', cost: 2725,
