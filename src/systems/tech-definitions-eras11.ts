...
const ERA_11_TECHS: Tech[] = [
  // MILITARY (2)
  { id: 'helicopter-warfare', name: 'Helicopter Warfare', track: 'military', cost: 2385,
  ...
  { id: 'icbm-development', name: 'ICBM Development', track: 'military', cost: 2385,
  ...
  // ECONOMY (2)
  { id: 'stagflation-response', name: 'Stagflation Response', track: 'economy', cost: 1650,
  ...
  // SCIENCE (2)
  { id: 'integrated-circuits', name: 'Integrated Circuits', track: 'science', cost: 2385,
  ...
  { id: 'molecular-biology', name: 'Molecular Biology', track: 'science', cost: 2385,
  ...
  // EXPLORATION (2)
  { id: 'space-exploration', name: 'Space Exploration', track: 'exploration', cost: 2385,
  ...
  // AGRICULTURE (2)
  { id: 'green-revolution-crops', name: 'Green Revolution Crops', track: 'agriculture', cost: 1650,
  ...
  // MEDICINE (2)
  { id: 'organ-transplantation', name: 'Organ Transplantation', track: 'medicine', cost: 1190,
  ...
  // PHILOSOPHY (2)
  { id: 'structuralism', name: 'Structuralism', track: 'philosophy', cost: 1650,
  ...
  { id: 'postmodernism', name: 'Postmodernism', track: 'philosophy', cost: 1140,
  ...
  { id: 'counterculture', name: 'Counterculture', track: 'arts', cost: 1650,
  ...
  // MARITIME (2)
  { id: 'nuclear-submarines', name: 'Nuclear Submarines', track: 'maritime', cost: 2385,
  ...
  { id: 'offshore-platforms', name: 'Offshore Platforms', track: 'construction', cost: 1650,
  ...
  // COMMUNICATION (2)
  { id: 'arpanet', name: 'ARPANET', track: 'communication', cost: 2385,
  ...
  { id: 'satellite-television', name: 'Satellite Television', track: 'communication', cost: 1650,
  ...
  // ESPIONAGE (2)
  { id: 'satellite-surveillance', name: 'Satellite Surveillance', track: 'espionage', cost: 2385,
  ...
  { id: 'black-ops-programs', name: 'Black Ops Programs', track: 'espionage', cost: 1650,
