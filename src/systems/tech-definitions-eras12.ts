...
const ERA_12_TECHS: Tech[] = [
  // MILITARY (2)
  { id: 'cyber-warfare', name: 'Cyber Warfare', track: 'military', cost: 3060,
  ...
  { id: 'stealth-technology', name: 'Stealth Technology', track: 'military', cost: 3060,
  ...
  // ECONOMY (2)
  { id: 'globalization', name: 'Globalization', track: 'economy', cost: 1530,
  ...
  { id: 'digital-economy', name: 'Digital Economy', track: 'economy', cost: 3060,
  ...
  // SCIENCE (2)
  { id: 'genomics', name: 'Genomics', track: 'science', cost: 1530,
  ...
  { id: 'cloud-computing', name: 'Cloud Computing', track: 'science', cost: 1530,
  ...
  // CIVICS (2)
  { id: 'digital-rights', name: 'Digital Rights', track: 'civics', cost: 1360,
    ...
    era: 12 },
  { id: 'network-governance', name: 'Network Governance', track: 'civics', cost: 1530,
  ...
  // EXPLORATION (2)
  { id: 'gps-navigation', name: 'GPS Navigation', track: 'exploration', cost: 1415,
    ...
    era: 12 },
  { id: 'private-spaceflight', name: 'Private Spaceflight', track: 'exploration', cost: 1415,
  ...
  // AGRICULTURE (2)
  { id: 'precision-agriculture', name: 'Precision Agriculture', track: 'agriculture', cost: 1530,
  ...
  // MEDICINE (2)
  { id: 'gene-therapy', name: 'Gene Therapy', track: 'medicine', cost: 1415,
  ...
  { id: 'telemedicine', name: 'Telemedicine', track: 'medicine', cost: 1415,
  ...
  // MARITIME (2)
  { id: 'autonomous-shipping', name: 'Autonomous Shipping', track: 'maritime', cost: 1530,
  ...
  // CONSTRUCTION (2)
  { id: 'smart-cities', name: 'Smart Cities', track: 'construction', cost: 1530,
  ...
  { id: 'green-architecture', name: 'Green Architecture', track: 'construction', cost: 1360,
  ...
  // COMMUNICATION (2)
  { id: 'internet', name: 'Internet Protocols', track: 'communication', cost: 1885,
  ...
  { id: 'social-media', name: 'Social Media', track: 'communication', cost: 1360,
  ...
  // ESPIONAGE (2)
  { id: 'cyber-intelligence', name: 'Cyber Intelligence', track: 'espionage', cost: 1530,
  ...
  { id: 'mindfulness-movement', name: 'Mindfulness Movement', track: 'spirituality', cost: 1415,
    ...
    era: 12 },
  { id: 'new-secularism', name: 'New Secularism', track: 'spirituality', cost: 1360,
