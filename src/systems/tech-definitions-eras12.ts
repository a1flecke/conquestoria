...
const ERA_12_TECHS: Tech[] = [
  // MILITARY (2)
  { id: 'cyber-warfare', name: 'Cyber Warfare', track: 'military', cost: 1445,
  ...
  { id: 'stealth-technology', name: 'Stealth Technology', track: 'military', cost: 1445,
  ...
  // ECONOMY (2)
  { id: 'globalization', name: 'Globalization', track: 'economy', cost: 780,
  ...
  { id: 'digital-economy', name: 'Digital Economy', track: 'economy', cost: 1000,
  ...
  // SCIENCE (2)
  { id: 'genomics', name: 'Genomics', track: 'science', cost: 1445,
  ...
  { id: 'quantum-computing', name: 'Quantum Computing', track: 'science', cost: 1445,
  ...
  // CIVICS (2)
  { id: 'digital-rights', name: 'Digital Rights', track: 'civics', cost: 690,
    ...
    era: 12 },
  { id: 'network-governance', name: 'Network Governance', track: 'civics', cost: 1000,
  ...
  // EXPLORATION (2)
  { id: 'gps-navigation', name: 'GPS Navigation', track: 'exploration', cost: 720,
    ...
    era: 12 },
  { id: 'private-spaceflight', name: 'Private Spaceflight', track: 'exploration', cost: 925,
  ...
  // AGRICULTURE (2)
  { id: 'precision-agriculture', name: 'Precision Agriculture', track: 'agriculture', cost: 780,
  ...
  { id: 'lab-grown-food', name: 'Lab-Grown Food', track: 'agriculture', cost: 1000,
    prerequisites: ['aquaculture', 'organ-transplantation'],
    unlocks: ['+2 food all cities'],
    era: 12 },

  // MEDICINE (2)
  { id: 'gene-therapy', name: 'Gene Therapy', track: 'medicine', cost: 925,
  ...
  { id: 'telemedicine', name: 'Telemedicine', track: 'medicine', cost: 720,
  ...
  // MARITIME (2)
  { id: 'autonomous-shipping', name: 'Autonomous Shipping', track: 'maritime', cost: 1000,
  ...
  // CONSTRUCTION (2)
  { id: 'smart-cities', name: 'Smart Cities', track: 'construction', cost: 1445,
  ...
  { id: 'green-architecture', name: 'Green Architecture', track: 'construction', cost: 690,
  ...
  // COMMUNICATION (2)
  { id: 'internet', name: 'Internet Protocols', track: 'communication', cost: 890,
  ...
  { id: 'social-media', name: 'Social Media', track: 'communication', cost: 690,
  ...
  // ESPIONAGE (2)
  { id: 'cyber-intelligence', name: 'Cyber Intelligence', track: 'espionage', cost: 1000,
  ...
  { id: 'mindfulness-movement', name: 'Mindfulness Movement', track: 'spirituality', cost: 720,
    ...
    era: 12 },
  { id: 'new-secularism', name: 'New Secularism', track: 'spirituality', cost: 690,
