...
const RELOCATED_STUBS: Tech[] = [
  { id: 'amphibious-warfare', name: 'Amphibious Warfare', track: 'maritime', cost: 630, prerequisites: ['caravels', 'naval-warfare'], unlocks: [], unlocksUnits: ['troop_transport', 'marine'], era: 5, countsForEraAdvancement: false },
];

const ERA_5_TECHS: Tech[] = [
  // MILITARY (2)
  { id: 'black-powder', name: 'Black Powder', track: 'military', cost: 630,
  ...
  { id: 'professional-army', name: 'Professional Army', track: 'military', cost: 360,
    prerequisites: ['tactics'],
    unlocks: ['Defending units in cities gain +10% strength'], era: 5 },

  // ECONOMY (2)
  { id: 'guilds', name: 'Guilds', track: 'economy', cost: 315,
  ...
  { id: 'colonial-trade', name: 'Colonial Trade', track: 'economy', cost: 630,
  ...
  // SCIENCE (2)
  { id: 'scientific-method', name: 'Scientific Method', track: 'science', cost: 280,
  ...
  { id: 'optics', name: 'Optics', track: 'science', cost: 360,
  ...
  // AGRICULTURE (2)
  { id: 'plantation-farming', name: 'Plantation Farming', track: 'agriculture', cost: 315,
    prerequisites: ['agricultural-science', 'irrigation'],
    unlocks: ['Farms yield +1 food'], era: 5 },
  { id: 'distillation', name: 'Distillation', track: 'agriculture', cost: 390,
    prerequisites: ['pottery'],
    unlocks: ['+2 gold from luxury resources'], unlocksBuildings: ['distillery'], era: 5 },

  // MEDICINE (2)
  { id: 'advanced-anatomy', name: 'Advanced Anatomy', track: 'medicine', cost: 295,
    prerequisites: ['anatomy', 'surgery'],
    unlocks: ['Units heal +1 HP faster when idle in friendly territory'], era: 5 },
  { id: 'herbalist-guilds', name: 'Herbalist Guilds', track: 'medicine', cost: 345,
  ...
  { id: 'classical-music-form', name: 'Classical Music Form', track: 'arts', cost: 345,
    prerequisites: ['theater'],
    unlocks: ['+1 science per culture building empire-wide'], era: 5 },

  // MARITIME (2)
  { id: 'deep-sea-routes', name: 'Deep-Sea Routes', track: 'maritime', cost: 390,
  ...
  { id: 'renaissance-architecture', name: 'Renaissance Architecture', track: 'construction', cost: 315,
    prerequisites: ['engineering', 'arches'],
    unlocks: ['+2 production in cities containing a wonder'], era: 5, countsForCityMaturity: true },
  { id: 'vaulted-ceilings', name: 'Vaulted Ceilings', track: 'construction', cost: 345,
    prerequisites: ['arches'],
    unlocks: ['All building costs reduced by 10%'], era: 5 },

  // COMMUNICATION (2)
  { id: 'printing-press', name: 'Printing Press', track: 'communication', cost: 280,
    prerequisites: ['writing', 'printing'],
    unlocks: ['+1 science per library empire-wide'], era: 5 },
  { id: 'postal-service', name: 'Postal Service', track: 'communication', cost: 390,
    prerequisites: ['road-building'],
    unlocks: ['+1 gold per road tile in your territory (max +10)'], era: 5 },

  // ESPIONAGE (2)
  { id: 'black-chambers', name: 'Black Chambers', track: 'espionage', cost: 315,
  ...
  { id: 'diplomatic-networks', name: 'Diplomatic Networks', track: 'espionage', cost: 390,
  ...
  // SPIRITUALITY (2)
  { id: 'reformation', name: 'Reformation', track: 'spirituality', cost: 315,
    prerequisites: ['theology-tech', 'pilgrimages'],
    unlocks: ['+2 science in cities with a temple'], era: 5 },
  { id: 'monastic-orders', name: 'Monastic Orders', track: 'spirituality', cost: 390,
...
const ERA_6_TECHS: Tech[] = [
  // MILITARY (2)
  { id: 'rifle-tactics', name: 'Rifle Tactics', track: 'military', cost: 690,
  ...
  { id: 'grenade-warfare', name: 'Grenade Warfare', track: 'military', cost: 745,
  ...
  // ECONOMY (2)
  { id: 'joint-stock-companies', name: 'Joint-Stock Companies', track: 'economy', cost: 370,
  ...
  // SCIENCE (2)
  { id: 'natural-history', name: 'Natural History', track: 'science', cost: 370,
  ...
  { id: 'hydraulics', name: 'Hydraulics', track: 'science', cost: 370,
  ...
  // MEDICINE (2)
  { id: 'surgical-school', name: 'Surgical School', track: 'medicine', cost: 345,
  ...
  { id: 'epidemic-control', name: 'Epidemic Control', track: 'medicine', cost: 460,
    prerequisites: ['herbalist-guilds'],
    unlocks: ['City population loss from famine halved'], era: 6 },

  // PHILOSOPHY (2)
  { id: 'enlightenment', name: 'Enlightenment', track: 'philosophy', cost: 370,
    prerequisites: ['empiricism', 'rationalism'],
    unlocks: ['+1 science per two population in cities'], era: 6 },
  { id: 'social-contract', name: 'Social Contract', track: 'philosophy', cost: 370,
  ...
  // MARITIME (2)
  { id: 'trade-winds', name: 'Trade Winds', track: 'maritime', cost: 345,
    prerequisites: ['deep-sea-routes', 'circumnavigation'],
    unlocks: ['Naval units gain +1 movement'], era: 6 },
  { id: 'frigate-construction', name: 'Frigate Construction', track: 'maritime', cost: 745,
    prerequisites: ['naval-gunnery'],
    unlocks: ['Frigate unlocked — fast armed escort'], unlocksUnits: ['frigate'], era: 6 },

  // METALLURGY (2)
  { id: 'precision-casting', name: 'Precision Casting', track: 'metallurgy', cost: 425,
    prerequisites: ['cannon-casting'],
    unlocks: ['Cannon units gain +5 strength; cannon cost -10%'], era: 6 },
  { id: 'steel-plate-armor', name: 'Steel Plate Armor', track: 'metallurgy', cost: 425,
    prerequisites: ['blast-furnace-tech'],
    unlocks: ['Land melee units gain +3 defense strength'], era: 6 },

  // CONSTRUCTION (2)
  { id: 'fortification-engineering', name: 'Fortification Engineering', track: 'construction', cost: 460,
  ...
  { id: 'aqueduct-expansion', name: 'Aqueduct Expansion', track: 'construction', cost: 370,
  ...
  // ESPIONAGE (2)
  { id: 'counter-espionage', name: 'Counter-Espionage', track: 'espionage', cost: 460,
  ...
  { id: 'propaganda', name: 'Propaganda', track: 'espionage', cost: 460,
    prerequisites: ['diplomatic-networks'],
    unlocks: ['Spy missions to flip loyalties available in foreign cities'], era: 6 },

  // SPIRITUALITY (2)
  { id: 'ecumenical-council', name: 'Ecumenical Council', track: 'spirituality', cost: 460,
    prerequisites: ['reformation'],
    unlocks: ['+2 gold per city with a temple empire-wide'], era: 6 },
  { id: 'missionary-zeal', name: 'Missionary Zeal', track: 'spirituality', cost: 460,
...
const ERA_7_TECHS: Tech[] = [
  // MILITARY (2)
  { id: 'rifled-infantry', name: 'Rifled Infantry', track: 'military', cost: 1025,
  ...
  { id: 'mass-mobilization', name: 'Mass Mobilization', track: 'military', cost: 555,
  ...
  { id: 'balloon-corps', name: 'Balloon Corps', track: 'military', cost: 1025,
  ...
  // ECONOMY (2)
  { id: 'steam-power', name: 'Steam Power', track: 'economy', cost: 685,
  ...
  // CIVICS (2)
  { id: 'nationalism', name: 'Nationalism', track: 'civics', cost: 555,
  ...
  // MEDICINE (2)
  { id: 'field-hospitals', name: 'Field Hospitals', track: 'medicine', cost: 515,
  ...
  { id: 'germ-theory', name: 'Germ Theory', track: 'medicine', cost: 515,
  ...
  // PHILOSOPHY (2)
  { id: 'utilitarianism', name: 'Utilitarianism', track: 'philosophy', cost: 555,
  ...
  { id: 'industrial-realism', name: 'Industrial Realism', track: 'arts', cost: 495,
    prerequisites: ['baroque-music', 'newspaper-press'],
    unlocks: ['Culture buildings generate +1 production'], era: 7 },

  // MARITIME (2)
  { id: 'ironclad-warships', name: 'Ironclad Warships', track: 'maritime', cost: 1110,
  ...
  { id: 'steam-navigation', name: 'Steam Navigation', track: 'maritime', cost: 1110,
  ...
  // METALLURGY (2)
  { id: 'steel-production', name: 'Steel Production', track: 'metallurgy', cost: 495,
  ...
  { id: 'iron-bridges', name: 'Iron Bridges', track: 'construction', cost: 555,
    prerequisites: ['aqueduct-expansion', 'steel-plate-armor'],
    unlocks: ['+1 gold per river city'], era: 7 },

  // COMMUNICATION (2)
  { id: 'popular-press', name: 'Popular Press', track: 'communication', cost: 495,
  ...
  { id: 'electric-telegraph', name: 'Electric Telegraph', track: 'communication', cost: 555,
  ...
  // ESPIONAGE (2)
  { id: 'covert-operations', name: 'Covert Operations', track: 'espionage', cost: 1110,
  ...
  { id: 'secret-police', name: 'Secret Police', track: 'espionage', cost: 555,
  ...
  // SPIRITUALITY (2)
  { id: 'secularism', name: 'Secularism', track: 'spirituality', cost: 555,
    prerequisites: ['ecumenical-council', 'enlightenment'],
    unlocks: ['+2 science in cities without a temple'], era: 7 },
  { id: 'social-gospel', name: 'Social Gospel', track: 'spirituality', cost: 515,
