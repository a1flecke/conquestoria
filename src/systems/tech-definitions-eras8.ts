...
const ERA_8_TECHS: Tech[] = [
  // MILITARY (2)
  { id: 'mass-firepower', name: 'Mass Firepower', track: 'military', cost: 1420,
  ...
  { id: 'general-mobilization', name: 'General Mobilization', track: 'military', cost: 810,
  ...
  // ECONOMY (2)
  { id: 'finance-capitalism', name: 'Finance Capitalism', track: 'economy', cost: 710,
  ...
  // SCIENCE (2)
  { id: 'germ-biology', name: 'Germ Biology', track: 'science', cost: 710,
  ...
  // CIVICS (2)
  { id: 'labor-rights', name: 'Labor Rights', track: 'civics', cost: 710,
  ...
  // EXPLORATION (2)
  { id: 'transcontinental-rail', name: 'Transcontinental Rail', track: 'exploration', cost: 710,
    prerequisites: ['colonial-railways', 'railway-expansion'],
    unlocks: ['Railway-connected cities earn +2 gold'], era: 8 },
  { id: 'imperial-survey', name: 'Imperial Survey', track: 'exploration', cost: 710,
  ...
  // PHILOSOPHY (2)
  { id: 'dialectical-materialism', name: 'Dialectical Materialism', track: 'philosophy', cost: 630,
  ...
  // METALLURGY (2)
  { id: 'bessemer-steel', name: 'Bessemer Steel', track: 'metallurgy', cost: 710,
  ...
  { id: 'structural-engineering', name: 'Structural Engineering', track: 'metallurgy', cost: 630,
  ...
  // CONSTRUCTION (2)
  { id: 'reinforced-concrete', name: 'Reinforced Concrete', track: 'construction', cost: 630,
  ...
  { id: 'disinformation-bureau', name: 'Disinformation Bureau', track: 'espionage', cost: 875,
  ...
  // SPIRITUALITY (2)
  { id: 'modernist-theology', name: 'Modernist Theology', track: 'spirituality', cost: 710,
  ...
  { id: 'social-justice', name: 'Social Justice', track: 'spirituality', cost: 775,
