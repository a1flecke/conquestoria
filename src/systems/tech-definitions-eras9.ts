...
const ERA_9_TECHS: Tech[] = [
  // MILITARY (2)
  { id: 'tank-warfare', name: 'Tank Warfare', track: 'military', cost: 1740,
  ...
  { id: 'armored-tactics', name: 'Armored Tactics', track: 'military', cost: 1740,
    prerequisites: ['tank-warfare', 'general-mobilization'],
    unlocks: ['Combined-arms doctrine; tanks gain +5 strength; modern line infantry replaces machine gunners; Motorized Transport and a Tank Depot enable Mechanized Infantry'],
    unlocksUnits: ['infantry', 'mechanized_infantry'], unlocksBuildings: ['mobilization_act'], era: 9 },
  { id: 'air-superiority', name: 'Air Superiority', track: 'military', cost: 1740,
    ...
    unlocksUnits: ['wwii_fighter', 'mobile_aa', 'air_freighter', 'paratrooper'],
    unlocksBuildings: ['anti_air_battery', 'air_force_command'], era: 9 },

  // ECONOMY (2)
  { id: 'petroleum-industry', name: 'Petroleum Industry', track: 'economy', cost: 870,
  ...
  { id: 'fordist-manufacturing', name: 'Fordist Manufacturing', track: 'economy', cost: 870,
  ...
  // EXPLORATION (2)
  { id: 'motorized-transport', name: 'Motorized Transport', track: 'exploration', cost: 1740,
  ...
  { id: 'aerial-survey', name: 'Aerial Survey', track: 'exploration', cost: 805,
  ...
  { id: 'modern-psychiatry', name: 'Modern Psychiatry', track: 'medicine', cost: 870,
  ...
  // PHILOSOPHY (2)
  { id: 'pragmatic-empiricism', name: 'Pragmatic Empiricism', track: 'philosophy', cost: 775,
  ...
  { id: 'jazz-age', name: 'Jazz Age', track: 'arts', cost: 870,
  ...
  { id: 'dreadnought-construction', name: 'Dreadnought Construction', track: 'maritime', cost: 1740,
  ...
  { id: 'submarine-warfare', name: 'Submarine Warfare', track: 'maritime', cost: 1740,
  ...
  { id: 'steel-skyscrapers', name: 'Steel Skyscrapers', track: 'construction', cost: 775,
  ...
  // COMMUNICATION (2)
  { id: 'radio-broadcast', name: 'Radio Broadcast', track: 'communication', cost: 870,
  ...
  // ESPIONAGE (2)
  { id: 'counterintelligence', name: 'Counterintelligence', track: 'espionage', cost: 1740,
