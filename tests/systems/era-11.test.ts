...
describe('era 11 tech tree', () => {
  ...
  it('all era 11 techs have cost in 700–2800 range', () => {
    for (const t of era11Techs) {
      expect(t.cost, `${t.id} cost out of range`).toBeGreaterThanOrEqual(700);
  ...
  return {
    ...
    civilizations: {
      'ai-1': {
        ...
        diplomacy: {
          relationships: {}, atWarWith: [], treaties: [], treatyRequestsSent: [], treatyRequestsReceived: [],
    ...
    const state = {
      ...
      civilizations: {
        'ai-1': {
          ...
          gold: 0, visibility: { tiles: {} }, score: 0, knownCivilizations: [],
          diplomacy: { relationships: {}, atWarWith: [], treaties: [], treatyRequestsSent: [], treatyRequestsReceived: [], vassalage: { overlord: null, vassals: [], protectionScore: 100, protectionTimers: [], peakCities: 2, peakMilitary: 0 } },
        },
      },
      barbarianCamps: {}, minorCivs: {},
      tutorial: { active: false, currentStep: 'complete', completedSteps: [] },
