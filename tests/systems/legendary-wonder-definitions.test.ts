...
describe('legendary-wonder-definitions', () => {
  it('matches the full approved M4 legendary wonder roster exactly', () => {
    ...
    expect(approved).toEqual(expect.arrayContaining(['manhattan-project', 'internet', 'sistine-vault', 'codex-eternal', 'navigators-compass', 'palace-of-the-sun', 'iron-arsenal', 'merchant-admiralty', 'crystal-palace', 'suez-canal', 'continental-congress', 'eiffel-tower', 'brooklyn-bridge', 'trans-siberian-railway']));
  });
